						...
						<view :hover-stay-time="200" class="u-collapse-head">
							<block>
								<view class="problemTitle">
									...
									<view class="right">
										<image src="../../static/out.png" mode="" @click="exportTaskIssue(item.tableList[0].id)"></image>
									</view>
								</view>
							</block>
						</view>
							...
							<view class="u-collapse-content" :id="elId">
								<view class="scorll-content">
									<scroll-view class="scroll-view_H" scroll-x="true"  scroll-left="120">
										...
										<view v-for="(i,index1) in item.tableList" class="tableheight">
											<view class="scorll-th">
...
<script>
	...
	export default {
		...
		methods: {
			...
			//导出问题数据
			exportTaskIssue(id){
				console.log( uni.getStorageSync("USER_ID"),"xxx")
				console.log(id,"xxx")
				helper.downloadTask(helper.websiteUrl + "v1/exportTaskIssueList?USER_ID=" + uni.getStorageSync("USER_ID") +
					"&id=" +id)
			},
		},
	}
